...
class Trackmanagement:
    ...
    def manage_tracks(self, unassigned_tracks, unassigned_meas, meas_list):  
        ...
        for track in self.track_list:
            ...
            x_var = track.P[0,0]
            y_var = track.P[1,1]
            #if (track.score <= params.delete_threshold and track.state =='confirmed') or (track.P[0, 0] >= params.max_P or track.P[1, 1] >= params.max_P):
            #if (track.score <= params.delete_threshold and track.state == 'confirmed') or ((track.state == 'initialized' or track.state == 'tentative') and (track.P[0, 0] >= params.max_P or track.P[1, 1] >= params.max_P)):
